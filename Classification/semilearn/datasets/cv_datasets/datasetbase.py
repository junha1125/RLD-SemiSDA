...
class BasicDataset(Dataset):
    ...
    def __init__(self,
        ...
        """
        Args
            data: image arrays like (50000, 32, 32, 3) for CIFAR100
    ...
    def __getitem__(self, idx):
        ...
        if self.transform is None:
            ...
            if not self.is_ulb:
                ...
                elif self.alg in ['guidingpl', 'contratta', 'cdac', 'guidingpldebias', 'contrattadebias', 'cdacdebias']:
                    return {'idx_ulb': idx, 'x_ulb_w': img_w, 'x_ulb_s_0': self.strong_transform(img), 'x_ulb_s_1':self.strong_transform(img), 'y_ulb': target} 
                else:
...
class BasicDatasetFromPath(BasicDataset):
    """
    This Class is for VisDA, DomainNet, and OfficeHome dataset.
    Args: 
        data: a list of image paths
    """
    def fetch_image(self, idx):
