...
@ALGORITHMS.register('contrattadebias')
class ContraTTADebias(AlgorithmBase):
    """
    ...
    def init(self, queue_size, m, T_moco, refine_method, ce_sup_type, num_neighbors, dist_type, contrast_type, alpha, beta, eta, reliable_rate=0.6, num_append=3):
