...
@ALGORITHMS.register('flexmatchdebias')
class FlexMatchDebias(AlgorithmBase):
    """
    ...
    def __init__(self, args, net_builder, tb_log=None, logger=None):
        ...
        self.init(T=args.T, p_cutoff=args.p_cutoff, hard_label=args.hard_label, thresh_warmup=args.thresh_warmup, reliable_rate=args.reliable_rate, num_append=args.num_append)
        self.append_type = get_append_type(args.append_type)
    
    def init(self, T, p_cutoff, hard_label=True, thresh_warmup=True, reliable_rate=0.6, num_append=3):
        self.T = T
    ...
    def load_model(self, load_path):
        ...
        if 'classwise_acc' not in checkpoint:
