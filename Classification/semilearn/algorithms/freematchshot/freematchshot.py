...
from semilearn.algorithms.hooks import PseudoLabelingHook, MemoryLabelHook
...
@ALGORITHMS.register('freematchshot')
class FreeMatchShot(AlgorithmBase):
    def __init__(self, args, net_builder, tb_log=None, logger=None):
        ...
        self.init(T=args.T, hard_label=args.hard_label, ema_p=args.ema_p, use_quantile=args.use_quantile, clip_thresh=args.clip_thresh, \
                  gen_pseudo_type=args.gen_pseudo_type, label_smoothing= args.label_smoothing)
        self.lambda_e = args.ent_loss_ratio

    def init(self, T, hard_label=True, ema_p=0.999, use_quantile=True, clip_thresh=False, gen_pseudo_type="sim_pred", label_smoothing=0.0):
        self.T = T
