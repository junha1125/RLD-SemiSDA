...
def create_clip_vit_L(img_size=224, use_checkpoint=False):
...
class ClipClassifier(nn.Module):
    def __init__(self, num_classes):
        ...
        self.encoder = create_clip_vit_L()
