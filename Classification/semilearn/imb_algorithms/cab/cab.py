...
from semilearn.core.utils import get_dataset, get_data_loader, send_model_cuda, ALGORITHMS
from semilearn.algorithms.utils import SSL_Argument, str2bool


@ALGORITHMS.register('cab')
class CaB(AlgorithmBase):
    def __init__(self, args, net_builder, tb_log=None, logger=None, **kwargs):
        self._init(num_gens=args.crest_num_gens, dist_align_t=args.crest_dist_align_t, pro_dist_align=args.crest_pro_dist_align, sampling_alpha=args.crest_alpha)
        super(CaB, self).__init__(args, net_builder, tb_log, logger, **kwargs)

    def _init(self, num_gens=6, dist_align_t=0.5, pro_dist_align=True, sampling_alpha=3):
