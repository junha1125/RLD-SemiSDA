...
ALL_MODULES = [
    ...
    ('semilearn.algorithms', ['adamatch', 'comatch', 'crmatch', 'dash', 'fixmatch', 'flexmatch', 'fullysupervised', 'meanteacher',
                              'mixmatch', 'pimodel', 'pseudolabel', 'remixmatch', 'simmatch', 'uda', 'vat', 'softmatch', 'freematch', 'defixmatch', 'simplefinetune', # SSL
                              'shot','nrc','guidingpl', 'contratta', 'makemost', # SFDA
                              'mme','cdac', # SSDA
                              'fixmatchsaver', 'freematchsaver', 'fixmatchshot', 'freematchshot', 'fixmatchdebias', 'freematchdebias', 'adamatchdebias',
                              'shotdebias', 'nrcdebias', 'udadebias', 'flexmatchdebias', 'cdacdebias', 'mmedebias', 'contrattadebias']),
