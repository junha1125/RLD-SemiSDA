...
class MIMIC_224_Dataset(MIMIC_Dataset):
    def __init__(self, imgpath, csvpath, metacsvpath, views=["PA"], transform=None, data_aug=None, seed=0, unique_patients=True):
        super().__init__(imgpath, csvpath, metacsvpath, views, transform, data_aug, seed, unique_patients)
        assert transform is None, "Transforms should be done for this dataset"
    ...
    def __getitem__(self, idx):
        ...
        img_path = os.path.join(self.imgpath, "p" + subjectid[:2], "p" + subjectid, "s" + studyid, dicom_id + ".npy")
